    ...
    <div className="overflow-hidden rounded-xl border border-rose-500/20 bg-acp-card backdrop-blur-md shadow-premium-card">
      <div className="border-b border-rose-500/10 bg-rose-500/5 px-5 py-4">
        <div className="flex items-center gap-3">
          <span className="flex h-9 w-9 items-center justify-center rounded-md bg-white/[0.015] border border-white/[0.02] text-rose-400 shadow-sm">
...
function AirtablePermissionState({ message }: { message: string }) {
  return (
    <section className="overflow-hidden rounded-xl border border-white/[0.02] bg-acp-card backdrop-blur-md shadow-panel">
      ...
      <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
        <div className="bg-acp-navy px-6 py-7 text-white sm:px-8">
          <div className="flex items-start gap-4">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg border border-white/15 bg-white/[0.02]">
        ...
        <div className="p-6 sm:p-8 bg-[#0a0f1d]/40">
          ...
          <div className="mt-4 overflow-hidden rounded-lg border border-white/[0.02] bg-white/[0.015]">
            <div className="border-b border-white/[0.02] bg-white/[0.015] px-4 py-3">
          ...
          <div className="mt-4 rounded-lg border border-white/[0.02] bg-white/[0.015] px-4 py-3">
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-white/[0.02] bg-acp-card backdrop-blur-md shadow-panel">
      <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
        <div className="bg-acp-navy px-6 py-7 text-white sm:px-8">
          <div className="flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-md border border-white/15 bg-white/[0.02]">
        ...
        <div className="p-6 sm:p-8 bg-[#0a0f1d]/40">
          ...
          <div className="mt-4 grid gap-2">
            {required.map((item) => (
              <div key={item} className="flex items-center justify-between gap-3 rounded-md border border-white/[0.02] bg-white/[0.015] px-3 py-2">
                <code className="text-xs font-semibold text-slate-300">{item}</code>
                <span className="rounded bg-white/[0.015] px-2 py-1 text-[11px] font-bold uppercase tracking-wide text-slate-400">
                  Missing
                </span>
              </div>
            ))}
...
function ReadOnlyFact({ icon, label }: { icon: ReactNode; label: string }) {
  return (
    <div className="rounded-md border border-white/[0.02] bg-white/[0.015] p-3">
...
function PermissionStep({ title, value }: { title: string; value: string }) {
  return (
    <div className="rounded-md border border-white/[0.02] bg-white/[0.015] px-4 py-3 shadow-sm">
