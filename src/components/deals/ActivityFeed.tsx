...
const EVENT_COLORS = {
  bronze:  "border-[#c5a059]/20 bg-[#c5a059]/5 text-[#c5a059]",
  ...
  return (
    <div className="space-y-4">
              ...
              <button
                ...
                className={cx(
                  ...
                  filterType === f.id
                    ...
                    : "border-white/[0.04] bg-white/[0.01] text-slate-500 hover:text-white"
                )}
              >
                {f.label}
              </button>
      ...
      {!isLoading && !error && filteredEvents.length === 0 && (
        <div className="py-12 border border-dashed border-white/[0.04] rounded-2xl text-center select-none">
        ...
        <div className="space-y-3">
          {filteredEvents.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="group relative flex gap-3 rounded-xl border border-white/[0.04] bg-white/[0.01] p-3 hover:border-white/[0.08] hover:bg-white/[0.02] transition-all duration-200"
              >
                {/* Event Icon Block */}
                <div className={cx(
                  ...
                  <div className="mt-2 flex items-center gap-1.5 flex-wrap text-[9px] font-semibold text-slate-600 select-none">
                    ...
                    {!dealId && event.dealId && (
                      <Link
                        ...
                        className="text-slate-500 hover:text-[#c5a059] font-semibold transition"
                      >
